...
Star Wars is the reason I do any of this. The VFX in those films — walkers wading through water, starfighters cutting through clouds, entire worlds that felt *lived-in* — is what pulled me into 3D and visual effects in the first place. The banner at the top of this page is a wallpaper I created as a tribute to that spark: the shots that started it, sitting alongside the tools I use now.

FORGE is that same childhood impulse, grown up. Those films needed hundreds of artists passing shots between departments — modeling to lighting to rendering to editorial. FORGE is my one-person version of that pipeline: describe the shot, and let the departments (Blender, Unreal, Premiere) hand it off between themselves.

*The banner is fan tribute art. Star Wars and all related elements belong to Lucasfilm Ltd. — this project has no affiliation with them, and none of it is for sale.*
